      ...
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-1/2">
            <AccordionItem
              header="How long we deliver your Product?"
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            />
            <AccordionItem
              header="hat shipping options do you have?"
              text='For Indian domestic orders we offer Card , NetBanking , UPI and COD shipping.'
            />
            <AccordionItem
              header="What payment methods do you accept?"
              text =' Any method of payments acceptable by you. For example: We accept MasterCard, Visa, UPI, PayPal, Gift Cards, etc.'
            />
          </div>
        </div>
      </div>
